        ...
        try {
            ...
            for (int i = 0; i < jsonArrayFeatures.length(); i++) {
                ...
                JSONObject properties
                        = currentEarthquake.getJSONObject("properties");
                double jsonObjectMag = properties.getDouble("mag");
                String jsonObjectPlace = properties.getString("place");
                String jsonObjectUri = properties.getString("url");
                long time = properties.getLong("time");
                Earthquake earthquake
                        = new Earthquake(jsonObjectMag, jsonObjectPlace, time, jsonObjectUri);
